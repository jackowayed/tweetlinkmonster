Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README", "Rakefile", "TODO", "lib/merb-builder", "lib/merb-builder/template.rb", "lib/merb-builder.rb", "spec/spec_helper.rb", "spec/controllers", "spec/controllers/builder.rb", "spec/controllers/views", "spec/controllers/views/capture_builder", "spec/controllers/views/capture_builder/index.xml.builder", "spec/controllers/views/builder_config", "spec/controllers/views/builder_config/index.xml.builder", "spec/controllers/views/partial_ivars", "spec/controllers/views/partial_ivars/_partial_builder.xml.builder", "spec/controllers/views/partial_ivars/index.xml.builder", "spec/controllers/views/concat_builder", "spec/controllers/views/concat_builder/index.xml.builder", "spec/controllers/views/builder_controller", "spec/controllers/views/builder_controller/index.xml.builder", "spec/controllers/views/partial_builder", "spec/controllers/views/partial_builder/_partial_builder.xml.builder", "spec/controllers/views/partial_builder/index.xml.builder", "spec/builder_spec.rb"]
  s.has_rdoc = true
