Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README", "Rakefile", "TODO", "lib/merb-assets.rb", "lib/merb-assets", "lib/merb-assets/assets_mixin.rb", "lib/merb-assets/assets.rb", "spec/spec_helper.rb", "spec/merb-assets_spec.rb"]
  s.has_rdoc = true
